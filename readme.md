...
RESTful API with Lumen will make the client to server communication easier with HTTP requests. In this project, I have practiced how to develop a real-world, RESTful API with Lumen.

Goal:
- [x] Build a practical, real-world RESTful APIs to communicate with the real world with Lumen.
...
- [x] Implement JWT in Lumen.


Of course, I have achieved most of the goals in this project. Let's Cheers. :smile:

Here, the project is stored for future reference. It may also help who wants to build or needs a Polls System RESTful API.
...
Here are:
* [Lumen v5.8](https://lumen.laravel.com/) : The stunningly fast micro-framework by Laravel..
...
* Admin can create polls question easily
* User can give his opinion by voting
...
[lumen-shield]:https://img.shields.io/badge/Lumen-v5.8-555.svg?style=flat-square&logo=lumen&labelColor=E74430&logoColor=fff
